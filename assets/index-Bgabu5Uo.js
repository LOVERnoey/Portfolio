      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 group", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-black bg-gradient-to-r from-[#38761d] to-[#1c5400] bg-clip-text text-transparent group-hover:from-[#1c5400] group-hover:to-[#38761d] transition-all duration-300", children: "Portfolio" })
              ] })
            }
          ),
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  {
                    to: item.href,
                    className: `flex items-center gap-3 px-6 py-3 rounded-xl font-bold text-sm transition-all duration-300 border-2 ${location.pathname === item.href ? "text-white bg-gradient-to-r from-[#1c5400] to-[#38761d] border-[#38761d] shadow-lg shadow-[#38761d]/30" : "text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-[#1c5400]/50 hover:to-[#38761d]/50 border-transparent hover:border-[#38761d] hover:shadow-md hover:shadow-[#38761d]/20"}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        motion.div,
                        {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 pt-4 pb-6 space-y-3 border-t-2 border-[#38761d] mt-4", children: navigation.map((item, index) => {
              const IconComponent = item.icon;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex-1 flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white mb-2 group-hover:text-[#38761d] transition-colors duration-300", children: project.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              className: "mb-3",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-3 py-1 bg-[#38761d] text-white text-sm font-bold rounded-full border-2 border-[#1c5400] shadow-md", children: project.position })
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-4", children: [
            ...
            project.technologies.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-3 py-1 bg-[#1c5400] text-gray-200 text-sm rounded-full font-medium", children: [
              "+",
                ...
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.a,
                    {
                      ...
                      whileTap: { scale: 0.9 },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { size: 32, className: "text-[#38761d]" })
                    }
                  )
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-lg", children: "© 2025 LOVERnoey. All rights reserved" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#38761d] font-semibold", children: "Built with React, TypeScript, and Tailwind CSS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
...
const Home = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-black overflow-hidden relative", children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.div,
                      {
                        ...
                        transition: { duration: 0.6 },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 18, className: "text-white group-hover:text-[#38761d] transition-colors duration-300" })
                      }
                    ),
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                motion.div,
                                {
                                  ...
                                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "text-[#38761d] mt-1 flex-shrink-0", size: 20 })
                                }
                              ),
...
const Technologies = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-black overflow-hidden relative pt-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [...Array(20)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        className: "absolute w-1 h-1 bg-[#38761d] rounded-full opacity-30",
