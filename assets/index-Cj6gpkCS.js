...
function applyGeneratorOptions(_k) {
  var _l = _k, { type } = _l, options = __objRest(_l, ["type"]);
  var _a, _b;
...
class AsyncMotionValueAnimation extends WithPromise {
  constructor(_m) {
    var _n = _m, { autoplay = true, delay: delay2 = 0, type = "keyframes", repeat = 0, repeatDelay = 0, repeatType = "loop", keyframes: keyframes2, name, motionValue: motionValue2, element } = _n, options = __objRest(_n, ["autoplay", "delay", "type", "repeat", "repeatDelay", "repeatType", "keyframes", "name", "motionValue", "element"]);
    var _a;
    super();
    this.stop = () => {
      var _a2, _b;
...
function buildSVGAttrs(state, _o, isSVGTag2, transformTemplate, styleProp) {
  var _p = _o, {
    attrX,
    attrY,
    attrScale,
...
function createMotionComponent(Component, { forwardMotionProps = false } = {}, preloadedFeatures, createVisualElement) {
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    return jsxRuntimeExports.jsxs(MotionContext.Provider, { value: context, children: [MeasureLayout2 && context.visualElement ? jsxRuntimeExports.jsx(MeasureLayout2, __spreadValues({ visualElement: context.visualElement }, configAndProps)) : null, useRender(Component, props, useMotionRef(visualState, context.visualElement, externalRef), visualState, isStatic, forwardMotionProps)] });
  }
...
function isTransitionDefined(_q) {
  var _r = _q, { when, delay: _delay, delayChildren, staggerChildren, staggerDirection, repeat, repeatType, repeatDelay, from, elapsed } = _r, transition = __objRest(_r, ["when", "delay", "delayChildren", "staggerChildren", "staggerDirection", "repeat", "repeatType", "repeatDelay", "from", "elapsed"]);
...
function initIntersectionObserver(_s) {
  var _t = _s, { root } = _t, options = __objRest(_t, ["root"]);
...
const featureBundle = __spreadValues(__spreadValues(__spreadValues(__spreadValues({}, animations), gestureAnimations), drag), layout);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.nav,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center h-18", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-3 group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-black text-lg", children: "R" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-black bg-gradient-to-r from-[#23426b] to-[#ff914d] bg-clip-text text-transparent group-hover:from-[#ff914d] group-hover:to-[#23426b] transition-all duration-300", children: "Portfolio" })
              ] })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex space-x-2", children: navigation.map((item, index) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  {
                    to: item.href,
                    className: `flex items-center gap-3 px-6 py-3 rounded-xl font-bold text-sm transition-all duration-300 border-2 ${location.pathname === item.href ? "text-white bg-gradient-to-r from-[#23426b] to-[#23426b] border-[#23426b] shadow-lg shadow-[#23426b]/30" : "text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-[#23426b]/50 hover:to-[#23426b]/50 border-transparent hover:border-[#ff914d] hover:shadow-md hover:shadow-[#ff914d]/20"}`,
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        motion.div,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconComponent, { size: 20 })
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tracking-wide", children: item.name })
                    ]
                  }
                )
              },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-2 pt-4 pb-6 space-y-3 border-t-2 border-[#ff914d] mt-4", children: navigation.map((item, index) => {
              const IconComponent = item.icon;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    ...
                    {
                      to: item.href,
                      className: `flex items-center gap-4 px-4 py-3 rounded-xl font-bold text-base transition-all duration-300 border-2 ${location.pathname === item.href ? "text-white bg-gradient-to-r from-[#23426b] to-[#23426b] border-[#23426b] shadow-lg shadow-[#23426b]/30" : "text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-[#23426b]/50 hover:to-[#23426b]/50 border-transparent hover:border-[#ff914d]"}`,
                      onClick: () => setIsOpen(false),
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(IconComponent, { size: 22 }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tracking-wide", children: item.name })
                      ]
                    }
                  )
...
const profileImage = "/Portfolio/profile.png";
const project1Img = "/Portfolio/project1.jpg";
const project2Img = "/Portfolio/project2.jpg";
const project3Img = "/Portfolio/project3.png";
const project4Img = "/Portfolio/project4.png";
const project5Img = "/Portfolio/project5.png";
const personalInfo = {
...
const projects = [
  ...
  },
  {
    ...
    githubUrl: "https://github.com/LOVERnoey/GEOgame",
    // Optional
  ...
  },
  {
    ...
    githubUrl: "https://github.com/LOVERnoey/CSD3201/tree/main/GameGuide",
    // Optional
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 flex-1 flex flex-col", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white mb-2 group-hover:text-[#ff914d] transition-colors duration-300", children: project.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              className: "mb-3",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-3 py-1 bg-[#23426b] text-white text-sm font-bold rounded-full border-2 border-[#ff914d] shadow-md", children: project.position })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 mb-4 line-clamp-2 flex-1", children: project.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 mb-4", children: [
            project.technologies.slice(0, 3).map((tech, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            project.technologies.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-3 py-1 bg-[#ff914d] text-white text-sm rounded-full font-medium", children: [
              "+",
            ...
            project.githubUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.a,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: "Code" })
                ]
              }
            ),
            project.liveUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.a,
              {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.footer,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 pt-20 pb-16 text-center relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            className: "space-y-6",
                ...
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.a,
                    {
                      ...
                      whileTap: { scale: 0.9 },
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { size: 32, className: "text-[#ff914d]" })
                    }
                  )
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-lg", children: "© 2025 LOVERnoey. All rights reserved" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#ff914d] font-semibold", children: "Built with React, TypeScript, and Tailwind CSS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
...
const Home = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#292929] overflow-hidden relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [...Array(20)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.section,
      {
        ...
        initial: "hidden",
        animate: "visible",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              className: "relative flex justify-center md:justify-start",
              variants: fadeInLeft,
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { variants: textReveal, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.h1,
                    {
                      ...
                      children: personalInfo.name.split(" ").map((word, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        motion.span,
                        {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    ...
                    children: socialLinksArray.map((link, index) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsx(
                        motion.a,
                        {
                          ...
                          title: link.platform,
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconComponent, { size: 24 })
                        },
                        index
                      );
                    })
...
const ProjectDetail = () => {
  ...
  const navigate = useNavigate();
  const project = projects.find((p) => p.id === Number(id2));
  if (!project) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.div,
                      {
                        ...
                        transition: { duration: 0.6 },
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 18, className: "text-white group-hover:text-[#ff914d] transition-colors duration-300" })
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm tracking-wide", children: "Back to Projects" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.div,
                      {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.div,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold text-lg tracking-wide", children: project.position })
                      ]
                    }
                  )
                }
                    ...
                    project.githubUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.a,
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "View Code" })
                        ]
                      }
                    ),
                    project.liveUrl && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            motion.div,
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { size: 20 })
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            motion.span,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-16 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { className: "relative overflow-hidden rounded-2xl shadow-2xl", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            motion.p,
                            {
                              ...
                              children: "Click to explore details"
                            }
                          )
                        ]
                      }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-12", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.section,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.section,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: project.features.map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          motion.div,
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                motion.div,
                                {
                                  ...
                                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "text-[#ff914d] mt-1 flex-shrink-0", size: 20 })
                                }
                              ),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300 font-medium", children: feature })
                            ]
                          },
                          index
                        )) })
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.section,
                  {
                    initial: { opacity: 0, y: 20 },
                    animate: { opacity: 1, y: 0 },
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: project.technologies.map((tech, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        motion.div,
                        {
...
function SiBlender(props) {
  return GenIcon({ "attr": { "role": "img", "viewBox": "0 0 24 24" }, "child": [{ "tag": "path", "attr": { "d": "M12.51 13.214c.046-.8.438-1.506 1.03-2.006a3.424 3.424 0 0 1 2.212-.79c.85 0 1.631.3 2.211.79.592.5.983 1.206 1.028 2.005.045.823-.285 1.586-.865 2.153a3.389 3.389 0 0 1-2.374.938 3.393 3.393 0 0 1-2.376-.938c-.58-.567-.91-1.33-.865-2.152M7.35 14.831c.006.314.106.922.256 1.398a7.372 7.372 0 0 0 1.593 2.757 8.227 8.227 0 0 0 2.787 2.001 8.947 8.947 0 0 0 3.66.76 8.964 8.964 0 0 0 3.657-.772 8.285 8.285 0 0 0 2.785-2.01 7.428 7.428 0 0 0 1.592-2.762 6.964 6.964 0 0 0 .25-3.074 7.123 7.123 0 0 0-1.016-2.779 7.764 7.764 0 0 0-1.852-2.043h.002L13.566 2.55l-.02-.015c-.492-.378-1.319-.376-1.86.002-.547.382-.609 1.015-.123 1.415l-.001.001 3.126 2.543-9.53.01h-.013c-.788.001-1.545.518-1.695 1.172-.154.665.38 1.217 1.2 1.22V8.9l4.83-.01-8.62 6.617-.034.025c-.813.622-1.075 1.658-.563 2.313.52.667 1.625.668 2.447.004L7.414 14s-.069.52-.063.831zm12.09 1.741c-.97.988-2.326 1.548-3.795 1.55-1.47.004-2.827-.552-3.797-1.538a4.51 4.51 0 0 1-1.036-1.622 4.282 4.282 0 0 1 .282-3.519 4.702 4.702 0 0 1 1.153-1.371c.942-.768 2.141-1.183 3.396-1.185 1.256-.002 2.455.41 3.398 1.175.48.391.87.854 1.152 1.367a4.28 4.28 0 0 1 .522 1.706 4.236 4.236 0 0 1-.239 1.811 4.54 4.54 0 0 1-1.035 1.626" }, "child": [] }] })(props);
}
...
function SiFramer(props) {
  return GenIcon({ "attr": { "role": "img", "viewBox": "0 0 24 24" }, "child": [{ "tag": "path", "attr": { "d": "M4 0h16v8h-8zM4 8h8l8 8H4zM4 16h8v8z" }, "child": [] }] })(props);
}
...
function SiJetbrains(props) {
  return GenIcon({ "attr": { "role": "img", "viewBox": "0 0 24 24" }, "child": [{ "tag": "path", "attr": { "d": "M7.529 8.753h-.705v.941h.706c.376 0 .565-.188.565-.471-.001-.329-.236-.47-.566-.47zm-3.2.282c0-.235-.188-.329-.471-.329h-.705v.706h.659c.329-.047.517-.141.517-.377zm6.212 1.13h.847l-.423-1.083zm-6.588 0h-.847v.706h.847c.329 0 .518-.141.518-.376s-.189-.33-.518-.33zM0 0v24h24V0H0zm8.424 3.012h3.435v.941h-1.176v2.965H9.6V3.953H8.424v-.941zm-.236 0v.894h-2.07v.612H8v.847H6.118v.612h2.118v.941H5.082l-.047-3.906h3.153zm-2.635 7.623c0 .659-.565 1.082-1.459 1.082H2.071V7.812h2.023c.471 0 .847.141 1.082.329.142.141.236.377.236.659 0 .471-.235.706-.612.894.471.141.753.424.753.941zM2.682 5.647c.188.235.376.376.612.376.282 0 .424-.188.424-.565V2.965H4.8v2.494c0 .471-.141.847-.376 1.082s-.612.377-1.083.377c-.706.047-1.082-.236-1.364-.612l.705-.659zm8.377 15.341H2.071v-1.506h8.988v1.506zm.894-9.223l-.282-.706h-1.506l-.282.706h-1.13l.02-.047h-.679l-.8-1.176h-.47v1.176H5.741V7.812h1.835c.612 0 .988.141 1.271.424.235.235.329.518.329.894 0 .612-.329.988-.8 1.224l.605.878 1.465-3.419h1.035l1.647 3.953h-1.175zm2.4-.047h-1.082V7.812h1.082v3.906zm3.953 0h-.941L15.718 9.6v2.165h-1.082V7.812h.988l1.6 2.071V7.812h1.082v3.906zm1.929.047a2.488 2.488 0 0 1-1.835-.612l.612-.706c.376.329.8.471 1.271.471.282 0 .471-.094.471-.282s-.141-.235-.659-.376c-.847-.188-1.459-.424-1.459-1.224 0-.706.565-1.271 1.506-1.271.659 0 1.176.188 1.6.518l-.565.753c-.377-.236-.753-.377-1.083-.377-.282 0-.376.094-.376.235 0 .188.141.235.659.376.894.188 1.459.471 1.459 1.224-.001.8-.612 1.271-1.601 1.271z" }, "child": [] }] })(props);
}
...
function SiSharp(props) {
  return GenIcon({ "attr": { "role": "img", "viewBox": "0 0 24 24" }, "child": [{ "tag": "path", "attr": { "d": "M14.2209.0875v5.9613l-3.7433.5012v3.5233l3.7433-.5012v3.5735l3.492-.4672V9.1047L24 8.2634l-.4631-3.4613-5.824.7794V.0875zM6.287 1.145v5.9618L0 7.9483l.4634 3.4613 5.8514-.7834 3.4644-.4637V1.145zm3.5198 9.7185l-3.492.4675v3.578l-6.183.8276.4633 3.4613 5.8239-.7796v5.4942h3.492v-5.962l3.6114-.4834V13.944l-3.7156.4973zm13.73 1.7405l-5.824.779-3.492.4673v9.0179h3.492v-5.9618L24 16.0652Z" }, "child": [] }] })(props);
}
...
function SiUnity(props) {
  return GenIcon({ "attr": { "role": "img", "viewBox": "0 0 24 24" }, "child": [{ "tag": "path", "attr": { "d": "m12.9288 4.2939 3.7997 2.1929c.1366.077.1415.2905 0 .3675l-4.515 2.6076a.4192.4192 0 0 1-.4246 0L7.274 6.8543c-.139-.0745-.1415-.293 0-.3675l3.7972-2.193V0L1.3758 5.5977V16.793l3.7177-2.1456v-4.3858c-.0025-.1565.1813-.2682.318-.1838l4.5148 2.6076a.4252.4252 0 0 1 .2136.3676v5.2127c.0025.1565-.1813.2682-.3179.1838l-3.7996-2.1929-3.7178 2.1457L12 24l9.6954-5.5977-3.7178-2.1457-3.7996 2.1929c-.1341.082-.3229-.0248-.3179-.1838V13.053c0-.1565.087-.2956.2136-.3676l4.5149-2.6076c.134-.082.3228.0224.3179.1838v4.3858l3.7177 2.1456V5.5977L12.9288 0Z" }, "child": [] }] })(props);
}
const Technologies = () => {
  const technologies = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#292929] overflow-hidden relative pt-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 overflow-hidden pointer-events-none", children: [...Array(20)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        className: "absolute w-1 h-1 bg-[#ff914d] rounded-full opacity-30",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-16 relative z-10", children: [
      ...
      Object.entries(groupedTechnologies).map(([category, techs], categoryIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.section,
        {
          className: "mb-16",
          initial: { opacity: 0, y: 50 },
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6", children: techs.map((tech, techIndex) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.div,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(tech.icon, { size: 48 })
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.h3,
...
const Projects = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#292929] overflow-hidden relative pt-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-16 relative z-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          className: "text-center mb-16",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                animate: { opacity: 1, y: 0 },
                transition: { delay: 0.2, duration: 0.6 },
                children: "A collection of games, web applications, and software projects I've developed"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(HashRouter, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "App", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "pt-18", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/project/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectDetail, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/technologies", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Technologies, {}) }),
